...
function App() {
  ...
  <div className="App">
    <main>
        ...
        <div class="form">
            <input type="text" class="email" placeholder="Email or phone number"/>
            <input type="password" class="password" placeholder="Password"/>
            <div class="login">
                <a href="https://www.facebook.com/" class="btn">Log in</a>
            </div>
            ...
            <p><a href="https://www.facebook.com/pages/create/?ref_type=registration_form">Create a Page</a> for celebrity, brand or business.</p>
         </div>
    </main>
    <br/>
    <br/>
